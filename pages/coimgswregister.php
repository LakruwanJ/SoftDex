    ...
    <body>
        ...
        if ($_SERVER['REQUEST_METHOD'] === "POST") {
            if (isset($_POST['submit'])) {
                if (empty($_POST['devname']) || empty($_POST['swname']) || empty($_POST['details']) || empty($_POST['dateofrelease'])) {
                    ...
                    $details = $_POST["details"];
                    $dateofrelease = $_POST["dateofrelease"];
                    $comingsoonswregister = new Comingsoonsw($devname, $swname, $details, $dateofrelease);
