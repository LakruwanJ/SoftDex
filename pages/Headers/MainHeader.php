        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link_  " href="pages/DisplayTutorials.php"><i class="fa-brands fa-leanpub icoon"></i>Tutorials</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php
                            if ($home->CheckUser($user)) {
                                ?>

                                <li><a class="dropdown-item " href="pages/profile.php"><i class="fas fa-user mr-2 icoon"></i>Profile</a></li>

                            <?php } else { ?>
                                <li><a class="dropdown-item" href="pages/CreateProfile.php"><i class="fa-solid fa-user-plus icoon"></i>Create Profile</a></li>
                                <?php }
                                ?>
