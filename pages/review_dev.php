...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $username = $devname = "";
    if (isset($_GET['username']) && isset($_GET['devname'])) {
...
<body>
    <div class="container">
    	<h1 class="mt-5 mb-5">Review & Rating of Developer</h1>
    	<div class="card">
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
                            <input type="text" name="dev_name" id="dev_name" class="form-control" placeholder="Enter Developer Name" value="<?=$devname ?>" />
